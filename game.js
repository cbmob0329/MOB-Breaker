...
const {
  Player,
  WaruMOB, IceRobo, /* IceRoboMini 削除 */ Kozou, MOBGiant, GabuKing, Screw
} = window.__Actors__;
...
class Game{
  ...
  async start(){
    const imgs=[
      ...
      // Skill2（tms）
      'tms1.png','tms2.png','tms3.png','tms4.png','tms5.png','tms6.png',
      // Skill3（drill）
      'dr1.png','dr2.png','dr3.png','dr4.png','dr5.png','dr6.png','dr7.png','dr8.png',
      // Skill4（air）
      'air1.png','air2.png','air3.png','air4.png','air5.png',
      // ULT2（PK）
    ...
    const group = (Ctor, count, baseX, gap)=>()=> {
      const arr=[];
      for(let i=0;i<count;i++){ arr.push(new Ctor(this.world,this.effects,this.assets, baseX + i*gap)); }
      return arr;
    };

    // ウェーブ構成（IceRoboMini は削除）
    this.enemyOrder = [
